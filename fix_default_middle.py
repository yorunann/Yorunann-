...
old_1 = '''                {/* Middle: Bases & Counts */}
                <div className="flex-1 flex flex-row sm:flex-col items-center justify-center w-full p-2 sm:p-2 gap-2 sm:gap-1 lg:gap-2 relative min-h-0">
                    <div className="w-1/2 sm:w-auto flex justify-end sm:justify-center mt-0 lg:mt-6 mb-0 lg:mb-2 shrink-0 transform scale-[0.85] sm:scale-80 lg:scale-100 origin-right sm:origin-center pr-4 sm:pr-0">'''
...
old_2 = '''                    <div className="w-1/2 sm:w-full flex justify-start sm:justify-center pb-0 shrink-0 pl-4 sm:pl-0">
                        <div className="flex flex-col space-y-2 items-start pl-0 lg:pl-8 sm:-ml-3 lg:ml-0">'''
                        
new_2 = '''                    <div className="w-1/2 sm:w-full flex justify-start sm:justify-center shrink-0 pl-4 sm:pl-0">
                        <div className="flex flex-col space-y-2 items-start pl-0 lg:pl-8 sm:-ml-3 lg:ml-0">'''
