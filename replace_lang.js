...
// For Display Mode Toggle, if it's flex space-x-1, make it responsive or use grid
content = content.replace(
  `                 <div className="flex space-x-1">`,
  `                 <div className={language === 'ja' ? "grid grid-cols-2 gap-1" : "flex space-x-1"}>`
);

// For visibility toggles, grid-cols-2 lg:grid-cols-3 -> might be okay as is, but maybe change text size
content = content.replace(
